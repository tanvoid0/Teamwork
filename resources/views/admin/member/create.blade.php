        ...
        <div class="row">
            <div class="col-md-6 col-md-offset-3">
                ...
                <div class="box box-info">
                    ...
                    <!-- /.box-header -->
                    <!-- form start -->
                    <form class="form-horizontal" method="post" action="{{ route('member.store') }}" enctype="multipart/form-data">
                        {{ csrf_field() }}
                        <div class="box-body">
                            {{--                            Image--}}
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" id="lolid" name="lolid"
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input type="messenger" class="form-control" id="messenger" name="messenger"
                        ...
                        <div class="box-footer">
                            ...
                            <button type="submit" class="btn btn-success pull-right"><i class="fa fa-plus-square"></i>
                                Add Member
                            </button>
                        </div>
                        <!-- /.box-footer -->
